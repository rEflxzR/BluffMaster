                            ...
                            <div className="d-flex">
                                <ul className="nav nav-tabs" id="myTab" role="tablist" style={{ width: "100%" }}>
                                    <li className="nav-item streambtn" role="presentation" style={{ width: "34%" }}>
                                        <a onClick={this.handleQuestionTabClick} className="nav-link active text-dark" type="button" id="question" data-toggle="tab" href="question" role="tab" aria-controls="btech" aria-selected="true">
